...
class Anchor(db.Model):
    ...
    momo_number = db.Column(db.String(60), index=True, nullable=False, unique=True)
    ...
    basic_salary = db.Column(db.Float, default=0, nullable=True)
    live_time = db.Column(db.Float, nullable=True)
    live_session = db.Column(db.String(60), nullable=True)
    percentage = db.Column(db.Float, default=0.0)
    ace_anchor_or_not = db.Column(db.Boolean, default=False, nullable=True)
